...
";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["personnages"]) || array_key_exists("personnages", $context) ? $context["personnages"] : (function () { throw new RuntimeError('Variable "personnages" does not exist.', 8, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["personnage"]) {
            // line 9
            echo "        <article>
            <h2> ";
            // line 10
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["personnage"], "nom", [], "any", false, false, false, 10), "html", null, true);
            echo "</h2>
            <div class=\"content\">
                <img src=\"";
            // line 12
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(twig_get_attribute($this->env, $this->source, $context["personnage"], "image", [], "any", false, false, false, 12)), "html", null, true);
            echo "\" style=\"width:350px; height:200px;\" alt=\"\">
                <p> ";
            // line 13
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["personnage"], "description", [], "any", false, false, false, 13), "html", null, true);
            echo " </p>
                <p> ";
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["personnage"], "game", [], "any", false, false, false, 14), "html", null, true);
            echo " </p>
                <a href=\"";
            // line 15
...
";
    ...
    {
        return array (  126 => 19,  116 => 15,  112 => 14,  108 => 13,  104 => 12,  99 => 10,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Smash Test{% endblock %}
